...
const translations = {
    'en': {
        ...
        'texto-125': '<a type="button" target="_blank" href="https://docs.google.com/spreadsheets/d/1aRsowVQmSFe2ebGrABYlhIiG-H1i2_xOXuiiXjRk52Y/edit?usp=sharing" class="btn btn-secondary texto texto-125">GitHub Link</a>',
        ...
        'texto-135': '<a type="button" class="btn btn-outline-secondary me-3 mb-3 texto texto-135">Resume PDF</a>',
    }
};
